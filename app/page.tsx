...
export default function Home() {
  return (
    <main>
      ...
      <section className="books-section cream-section" id="books"><div className="shell books-grid"><div className="books-copy"><p className="section-kicker">Books from the front</p><h2>The story.<br /><em>The strategy.</em></h2><p>Stolen Sons is the story of father erasure, abduction and international custody litigation. Family Lawfare is the field manual for fathers who need to understand the battlefield before temporary damage becomes permanent.</p><Link className="button ink" href="/books">View all books</Link></div><BookStack /></div></section>

      <section className="work-section dark-section home-work-dossier" id="work"><div className="shell"><div className="section-heading split-heading home-work-heading"><div><p className="section-kicker">Work with Steve</p><h2>For fathers who refuse<br /><em>to be erased.</em></h2></div><p>When custody, family court, alienation, or abduction threatens your relationship with your children, you need more than information. You need the strategy, discipline, and support to lead the fight without letting it destroy the rest of your life.</p></div><div className="wsc-offers"><article className="wsc-card"><span className="wsc-label">Group program</span><h3>Brotherhood</h3><p>A private coaching group for fathers who need weekly strategy, accountability, and support while navigating family court or rebuilding from its consequences.</p><div className="wsc-price"><strong>$497</strong><span>/ month</span></div><Link className="button inverse-ink" href="/brotherhood">Explore Brotherhood</Link><small>Founding cohort opening soon.</small></article><article className="wsc-card"><span className="wsc-label">Private advisory</span><h3>Advisory</h3><p>Private strategic counsel for fathers facing complex litigation, significant business or asset exposure, interstate or international conflict, abduction, or enforcement.</p><div className="wsc-price"><strong>$297</strong><span>60-minute call</span></div><Link className="button ember" href="/advisory">Explore Advisory</Link></article></div></div></section>
      ...
      <section className="legacy-photo"><div className="legacy-overlay" /><div className="shell legacy-copy"><p className="section-kicker">What remains</p><h2>The battle is temporary.<br /><em>The bloodline is not.</em></h2><Link className="button inverse-ink" href="/about">Read Steve&apos;s story</Link></div></section>
      <Footer />
    </main>
  );
}
