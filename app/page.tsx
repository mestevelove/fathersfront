...
export default function Home() {
  return (
    <main>
      ...
      <section className="work-section dark-section home-work-dossier" id="work"><div className="shell"><div className="section-heading split-heading home-work-heading"><div><p className="section-kicker">Work with Steve</p><h2>For men building<br /><em>through battle.</em></h2></div><p>When the decisions carry consequences across your family, business, and future, you need more than advice. You need someone who has been in the fire.</p></div><div className="wsc-offers"><article className="wsc-card"><span className="wsc-label">Group program</span><h3>Bloodline Brotherhood</h3><p>A private group for men strengthening Leadership, Lifestyle, Law, and Love together.</p><div className="wsc-price"><strong>$497</strong><span>/ month</span></div><Link className="button outline" href="/bloodline-brotherhood">Enroll Now</Link><small>Founding cohort opening soon.</small></article><article className="wsc-card"><span className="wsc-label">Private advisory</span><h3>Bloodline Advisory</h3><p>Strategic counsel for high-net-worth founders, seven-figure entrepreneurs, business owners, and senior leaders.</p><div className="wsc-price"><strong>$297</strong><span>60-minute call</span></div><Link className="button ember" href="/bloodline-advisory">Enroll Now</Link><small>Private engagements begin at $15,000.</small></article></div></div></section>
